...
function eleccion2(){
    slider1.style.marginLeft = "-520px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-40px";
    miniSlider.style.transition = "0.5s";
}

function eleccion3(){
    slider1.style.marginLeft = "-1185px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-105px";
    miniSlider.style.transition = "0.5s";
}

function eleccion4(){
    slider1.style.marginLeft = "-1850px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-180px";
    miniSlider.style.transition = "0.5s";
}

function eleccion5(){
    slider1.style.marginLeft = "-2495px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-275px";
    miniSlider.style.transition = "0.5s";
}

function eleccion6(){
    slider1.style.marginLeft = "-3170px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-360px";
    miniSlider.style.transition = "0.5s";
}

function eleccion7(){
    slider1.style.marginLeft = "-3830px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-410px";
    miniSlider.style.transition = "0.5s";
}
