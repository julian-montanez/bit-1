...
function eleccion2(){
    slider1.style.marginLeft = "-400px";
    slider1.style.transition = "0.5s";
...
function eleccion3(){
    slider1.style.marginLeft = "-1100px";
    slider1.style.transition = "0.5s";
...
function eleccion4(){
    slider1.style.marginLeft = "-1765px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-170px";
    miniSlider.style.transition = "0.5s";
}

function eleccion5(){
    slider1.style.marginLeft = "-2470px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-255px";
    miniSlider.style.transition = "0.5s";
}

function eleccion6(){
    slider1.style.marginLeft = "-3125px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-340px";
    miniSlider.style.transition = "0.5s";
}

function eleccion7(){
    slider1.style.marginLeft = "-3790px";
    slider1.style.transition = "0.5s";
    miniSlider.style.marginLeft = "-405px";
    miniSlider.style.transition = "0.5s";
}
